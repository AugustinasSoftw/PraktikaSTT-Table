...
export function NextButton({ disabled }: ButtonProps) {
  return (
    <span
      className={`inline-flex items-center justify-center rounded-md bg-zinc-700 h-9 w-9 text-zinc-200 shadow-sm ring-1 ring-zinc-700/60 transition-all duration-160 hover:bg-zinc-800/70
        ${disabled ? "opacity-60 cursor-not-allowed hover:bg-zinc-700" : ""}`}
    >
